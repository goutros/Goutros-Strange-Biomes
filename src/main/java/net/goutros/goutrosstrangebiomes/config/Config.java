...
public class Config {
    ...
    // Fix: Use ModConfigEvent.Loading and public static
    @SubscribeEvent
    ...
    // Optionally, also handle reload for config hot-reload support
    @SubscribeEvent
    public static void onConfigReload(final ModConfigEvent.Reloading event) {
        if (event.getConfig().getSpec() == SPEC) {
            onConfigLoad(new ModConfigEvent.Loading(event.getConfig()));
        }
    }
}
